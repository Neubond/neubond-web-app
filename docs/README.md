...
Engineering documentation for the **Neubond Web Portal** (`neubond-web-portal`).
...
| [`../sbom/`](../sbom/) | Generated SBOM and vulnerability report output, committed per branch. Lives at the repository root, not under `docs/` |
...
- `sbom/` — generated SBOM output at the repository root, outside the QMS boundary
